...
namespace WorkingWithEntityFrameworkCore.Controllers
{
    public class WebUsersController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.WebUsers != null ? 
                          ...
                          Problem("Entity set 'AppDbContext.WebUsers'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AppDbContext.WebUsers'  is null.");
            }
            var webUser = await _context.WebUsers.FindAsync(id);
            if (webUser != null)
            {
        ...
        {
          return (_context.WebUsers?.Any(e => e.UserID == id)).GetValueOrDefault();
        }
    }
}
